...
/// emit-time inputs. The synthesized command line is what keeps <c>complog rsp</c> /
/// <c>replay</c> / <c>export</c> functional on workspace-derived logs; consumers should
/// treat it as best-effort rather than an exact record of a compiler invocation.
/// </para>
/// </remarks>
internal static class WorkspaceCommandLineSynthesizer
{
    internal static string[] Synthesize(Project project, Compilation compilation)
    {
